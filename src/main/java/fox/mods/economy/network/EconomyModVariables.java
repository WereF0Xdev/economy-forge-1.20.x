package fox.mods.economy.network;
...
public class EconomyModVariables {
    ...
    public static void init(FMLCommonSetupEvent event) {
        EconomyMod.addNetworkMessage(PlayerVariablesSyncMessage.class, PlayerVariablesSyncMessage::buffer, PlayerVariablesSyncMessage::new, PlayerVariablesSyncMessage::handler);
    }
